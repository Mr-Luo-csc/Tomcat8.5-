...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        //TODO 这里其实是通过反射由Bootstrap启动了Catalina
    ...
    private void load(String[] arguments) throws Exception {
        ...
        //TODO 通过反射调用 catalinaDaemon 对象的 load 方法
    ...
    public void start() throws Exception {
        ...
        //TODO 通过反射调用 catalinaDaemon 对象上的 start 方法
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                //TODO 一下两个方法是非常重要的
                //1、通过反射调用 catalinaDaemon 对象的 load 方法
                //2、通过反射调用 catalinaDaemon 对象上的 start 方法
                daemon.load(args);
                daemon.start();
